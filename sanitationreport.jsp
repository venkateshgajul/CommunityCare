...
<body>
<div id="fullPage">
    <h2>SANITATION ISSUES REPORTS</h2>
            ...
            <tbody>
                <% 
                   ...
                   try {
                       ...
                       rs = stmt.executeQuery("SELECT * FROM sanitationreports");
                       while (rs.next()) { %>
                <tr>
                   <td><img src="<%= rs.getString("image_url") %>" alt="WaterIssue Image" width="100"></td>
                    ...
                    <td>
                      <form action="sanitationstatus.jsp" method="POST">
...
document.getElementById('downloadPDF').addEventListener('click', () => {
    ...
    const opt = {
        ...
        filename: 'Sanitation_Issue_Report.pdf', 
