...
<body>
<div id="fullPage">
    <h2>ELECTRICITY ISSUES REPORTS</h2>
            ...
            <tbody>
                <% 
                   ...
                   try {
                       ...
                       rs = stmt.executeQuery("SELECT * FROM electricityreports");
                       while (rs.next()) { %>
                <tr>
                   <td><img src="<%= rs.getString("image_url") %>" alt="WaterIssue Image" width="100"></td>
                    ...
                    <td><%= rs.getString("nearby_place") %></td>
                    <td><%= rs.getString("status") %></td>
                    <td>
                      <form action="electricitystatus.jsp" method="POST">
                        <input type="hidden" name="issueId" value="<%= rs.getInt("id") %>">
...
document.getElementById('downloadPDF').addEventListener('click', () => {
    ...
    const opt = {
        ...
        filename: 'Electricity_Issue_Report.pdf', 
