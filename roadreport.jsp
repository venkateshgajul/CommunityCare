            ...
            <tbody>
                <% 
                   ...
                   try {
                       ...
                       rs = stmt.executeQuery("SELECT * FROM roadreports");
                       while (rs.next()) { %>
                <tr>
                   <td><img src="<%= rs.getString("image_url") %>" alt="WaterIssue Image" width="100"></td>
                    ...
                    <td>
                      <form action="roadstatus.jsp" method="POST">
...
document.getElementById('downloadPDF').addEventListener('click', () => {
    ...
    const opt = {
        ...
        filename: 'Road_Issue_Report.pdf', 
